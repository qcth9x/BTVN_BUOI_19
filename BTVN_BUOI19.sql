...
INSERT INTO Movie(id , tenPhim , idTheLoai , idDanhMuc , ngaySanXuat , giaPhim )
 VALUES 
	('m01','tam quoc chi','tl01', 'dm01', '10/8/2010', '350000'),
	('m02','hong lau mong', 'tl01', 'dm01', '10/7/2010', '200000'),
	('m03','thuy huu', 'tl01', 'dm01', '10/8/2010', '100000'),
	('m04','tay du ky', 'tl01','dm01' ,'10/8/2010', '150000');

INSERT INTO Rent(id , thoiGianThue , idNguoiThue , idPhim , idDanhMuc , soTien , thoiGianTra)
VALUES
	('mtp01','2023-01-31 10:00:00', 1 , 'm01', 'dm01' , '200000' , '2023-01-31 11:00:00')
	;
INSERT INTO Rent(id , thoiGianThue , idNguoiThue , idPhim , idDanhMuc , soTien , thoiGianTra)
VALUES
	('mtp02','2023-01-31 10:00:00', 2 , 'm01', 'dm01' , '200000' , '2023-01-31 11:00:00')
	;
INSERT INTO Rent(id , thoiGianThue , idNguoiThue , idPhim , idDanhMuc , soTien , thoiGianTra)
VALUES
	('mtp03','2023-01-31 10:00:00', 3 , 'm01', 'dm02' , '200000' , '2023-01-31 11:00:00')
	;
INSERT INTO Rent(id , thoiGianThue , idNguoiThue , idPhim , idDanhMuc , soTien , thoiGianTra)
VALUES
	('mtp04','2023-01-31 11:00:00', 1 , 'm02', 'dm01' , '200000' , '2023-01-31 12:00:00')
	;
    INSERT INTO Rent(id , thoiGianThue , idNguoiThue , idPhim , idDanhMuc , soTien , thoiGianTra)
VALUES
	('mtp05','2023-01-31 11:00:00', 3 , 'm02', 'dm01' , '200000' , '2023-01-31 12:00:00')
	;
    select * from Rent;
    select * from Movie;
